...
print("\nNext: pick names from the list above (without the 'models/' prefix)")
print("for GEMINI_MODEL and GEMINI_WRITER_MODEL in your .env. A 'flash' one")
print("is cheapest/fastest for GEMINI_MODEL; a 'pro' one is best for the writers.")
